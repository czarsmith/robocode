...
public class Czar extends AdvancedRobot {
    ...
    @Override
    public void run() {
        setColors(new Color(200, 100, 50), new Color(255, 155, 75), new Color(255, 155, 75));
